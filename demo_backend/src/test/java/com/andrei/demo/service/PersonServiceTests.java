...
class PersonServiceTests {
    ...
    void testGetPeople() {
        ...
        List<PersonResponseDTO> result = personService.getPeople();
    ...
    void testUpdatePersonNotFound() {
        ...
        // then:
        assertThrows(ResourceNotFoundException.class, () -> personService.updatePerson(uuid, person));
        verify(personRepository, times(1)).findById(uuid);
    }
    ...
    void testDeletePerson() {
        ...
        // when:
        when(personRepository.existsById(uuid)).thenReturn(true);
